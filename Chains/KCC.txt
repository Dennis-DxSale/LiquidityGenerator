...
interface IERC20 {
     ...
     *
     * Returns a boolean value indicating whKCSer the operation succeeded.
     *
     ...
     * Returns a boolean value indicating whKCSer the operation succeeded.
     *
     * IMPORTANT: Beware that changing an allowance with this mKCSod brings the risk
     * that someone may use both the old and the new allowance by unfortunate
     * transaction ordering. One possible solution to mitigate this race
     * condition is to first reduce the spender's allowance to 0 and set the
     * desired value afterwards:
     * https://github.com/KCSereum/EIPs/issues/20#issuecomment-263524729
     *
...
abstract contract Context {
    ...
    function _msgData() internal view virtual returns (bytes memory) {
        this; // silence state mutability warning without generating bytecode - see https://github.com/KCSereum/solidity/issues/2691
        return msg.data;
    }
}
...
library Address {
     ...
     *
     * https://eips.KCSereum.org/EIPS/eip-1884[EIP1884] increases the gas cost
...
contract LiquidityGeneratorToken is Context, IERC20, Ownable {
    ...
    address public router = 0xc0fFee0000C824D24E0F280f1e4D21152625742b; // koffeeswap mainnet
    ...
    constructor (address tokenOwner,string memory name, string memory symbol,uint8 decimal, uint256 amountOfTokenWei,uint8 setTaxFee, uint8 setLiqFee, uint256 _maxTaxFee, uint256 _maxLiqFee, uint256 _minMxTxPer) public {
        ...
        IKoffeeSwapPair = KoffeeSwapFactory(_uniswapV2Router.factory())
            .createPair(address(this), _uniswapV2Router.WKCS());
    ...
    function setSwapAndLiquifyEnabled(bool _enabled) public onlyOwner {
     ...
     //to recieve KCS from uniswapV2Router when swaping
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for KCS
        swapTokensForKCS(half); // <- this breaks the KCS -> HATE swap when swap+liquify is triggered
    ...
    function swapTokensForKCS(uint256 tokenAmount) private {
    ...
    function addLiquidity(uint256 tokenAmount, uint256 KCSAmount) private {
        ...
        // add the liquidity
        uniswapV2Router.addLiquidityKCS{value: KCSAmount}(
            address(this),
            tokenAmount,
    ...
    //this mKCSod is responsible for taking all fee, if takeFee is true
